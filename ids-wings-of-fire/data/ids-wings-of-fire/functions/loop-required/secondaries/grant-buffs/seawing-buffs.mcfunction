...
execute if entity @s[tag=!Streamline1,tag=!Streamline2,tag=!Amphibious1,tag=!Amphibious2] run function ids-wings-of-fire:loop-required/secondaries/oceans-blessing
	...
	#Duo
		#Streamline 1, 2
		#Amphibious 1, 2
execute if entity @s[tag=Streamline1,tag=Amphibious1] run function ids-wings-of-fire:loop-required/secondaries/upgraded-abilities/seawings/duo/ep1du1
execute if entity @s[tag=Streamline1,tag=Amphibious2] run function ids-wings-of-fire:loop-required/secondaries/upgraded-abilities/seawings/duo/ep1du2
execute if entity @s[tag=Streamline2,tag=Amphibious1] run function ids-wings-of-fire:loop-required/secondaries/upgraded-abilities/seawings/duo/ep2du1
execute if entity @s[tag=Streamline2,tag=Amphibious2] run function ids-wings-of-fire:loop-required/secondaries/upgraded-abilities/seawings/duo/ep2du2
