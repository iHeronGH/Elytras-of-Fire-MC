...
execute if entity @s[tag=!HighWinds1,tag=!HighWinds2,tag=!Drought1,tag=!Drought2] run function ids-wings-of-fire:loop-required/secondaries/desert-storm
	...
	#Duo
		#HighWinds 1, 2
		#Drought 1, 2
execute if entity @s[tag=HighWinds1,tag=Drought1,tag=!Drought2] run function ids-wings-of-fire:loop-required/secondaries/upgraded-abilities/sandwings/duo/cd1du1
execute if entity @s[tag=HighWinds1,tag=!Drought1,tag=Drought2] run function ids-wings-of-fire:loop-required/secondaries/upgraded-abilities/sandwings/duo/cd1du2
execute if entity @s[tag=HighWinds2,tag=Drought1,tag=!Drought2] run function ids-wings-of-fire:loop-required/secondaries/upgraded-abilities/sandwings/duo/cd2du1
execute if entity @s[tag=HighWinds2,tag=!Drought1,tag=Drought2] run function ids-wings-of-fire:loop-required/secondaries/upgraded-abilities/sandwings/duo/cd2du2
