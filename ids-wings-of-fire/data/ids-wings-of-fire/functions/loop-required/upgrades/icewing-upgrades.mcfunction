...
execute as @p if entity @s[scores={Permafrost1=1..}] run function ids-wings-of-fire:loop-required/generate-tags/check-upgrades/icewings/permafrost-1
execute as @p if entity @s[scores={Permafrost2=1..}] run function ids-wings-of-fire:loop-required/generate-tags/check-upgrades/icewings/permafrost-2
