...
execute if entity @s[tag=!CoolDown1,nbt={SelectedItem:{tag:{stock:1}}}] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["FlameLine"],Particle:"block air",Duration:14,Radius:1f}

#Rotate FlameLine
execute as @e[type=area_effect_cloud,tag=FlameLine] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~ ~
