...
#Execute Venom Shot
execute if entity @s[tag=!CoolDown1,tag=!Reaction1,tag=Noxious1,tag=Potency1] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["rain_cd2le1ri1","getRot"],Particle:"block air",Duration:14,Radius:1f}
