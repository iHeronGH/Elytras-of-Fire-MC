...
execute as @e[type=area_effect_cloud,tag=sea_cd2le1] at @s unless block ^ ^0.1 ^0.1 #ids-wings-of-fire:families/projectile-immune unless block ^ ^0.1 ^0.1 water run kill @s
