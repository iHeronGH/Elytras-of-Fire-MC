...
#Rotate sea_cd3le2-s
execute as @e[type=area_effect_cloud,tag=sea_cd3le2-1] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~-35 ~
execute as @e[type=area_effect_cloud,tag=sea_cd3le2-2] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~-17.5 ~
execute as @e[type=area_effect_cloud,tag=sea_cd3le2-3] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~ ~
execute as @e[type=area_effect_cloud,tag=sea_cd3le2-4] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~17.5 ~
execute as @e[type=area_effect_cloud,tag=sea_cd3le2-5] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~35 ~
