...
#Rotate sea_cd2ri1-s
execute as @e[type=area_effect_cloud,tag=sea_cd2ri1-1] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~-40 ~
execute as @e[type=area_effect_cloud,tag=sea_cd2ri1-2] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~-20 ~
execute as @e[type=area_effect_cloud,tag=sea_cd2ri1-3] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~ ~
execute as @e[type=area_effect_cloud,tag=sea_cd2ri1-4] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~20 ~
execute as @e[type=area_effect_cloud,tag=sea_cd2ri1-5] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~40 ~
