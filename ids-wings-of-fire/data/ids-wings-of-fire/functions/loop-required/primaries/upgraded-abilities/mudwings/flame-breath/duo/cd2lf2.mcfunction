...
execute if entity @s[tag=!CoolDown1,tag=Furnace2,tag=Everburn2,tag=!Inferno1] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["mud_cd2lf2"],Particle:"block air",Duration:14,Radius:1f}

#Rotate mud_cd2lf2
execute as @e[type=area_effect_cloud,tag=mud_cd2lf2] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~ ~
