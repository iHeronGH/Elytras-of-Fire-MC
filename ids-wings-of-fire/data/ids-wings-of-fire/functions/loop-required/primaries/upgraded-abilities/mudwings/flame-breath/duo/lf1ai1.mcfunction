...
execute if entity @s[tag=!CoolDown1,tag=!Furnace1,tag=Everburn1,tag=Inferno1] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["mud_lf1ai1"],Particle:"block air",Duration:14,Radius:1f}

#Rotate mud_lf1ai1
execute as @e[type=area_effect_cloud,tag=mud_lf1ai1] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~ ~
