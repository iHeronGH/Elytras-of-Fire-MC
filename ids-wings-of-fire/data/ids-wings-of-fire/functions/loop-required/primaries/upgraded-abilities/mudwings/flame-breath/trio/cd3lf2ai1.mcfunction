...
execute if entity @s[tag=!CoolDown1,tag=Furnace3,tag=Everburn2,tag=Inferno1] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["mud_cd3lf2ai1"],Particle:"block air",Duration:14,Radius:1f}

#Rotate mud_cd3lf2ai1
execute as @e[type=area_effect_cloud,tag=mud_cd3lf2ai1] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~ ~
...
execute as @e[type=area_effect_cloud,tag=mud_cd3lf2ai1] at @s positioned ^ ^-1.33 ^0.45 if entity @e[type=!#arrows,type=!area_effect_cloud,type=!item,distance=..0.75] run kill @s
