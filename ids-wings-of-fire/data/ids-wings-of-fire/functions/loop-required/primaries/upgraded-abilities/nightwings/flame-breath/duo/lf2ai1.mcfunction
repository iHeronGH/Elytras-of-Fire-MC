...
execute if entity @s[tag=!CoolDown1,tag=!Superheat1,tag=EternalFlame2,tag=Fission1] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["night_lf2ai1"],Particle:"block air",Duration:14,Radius:1f}

#Rotate night_lf2ai1
execute as @e[type=area_effect_cloud,tag=night_lf2ai1] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~ ~
