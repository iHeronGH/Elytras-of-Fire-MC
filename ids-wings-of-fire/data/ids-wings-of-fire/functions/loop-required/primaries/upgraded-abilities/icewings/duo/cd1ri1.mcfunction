...
execute if entity @s[tag=!CoolDown1,tag=ArcticCore1,tag=!Permafrost1,tag=Icefall1] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["ice_cd1ri1"],Particle:"block air",Duration:18,Radius:1f}

#Rotate ice_cd1ri1
execute as @e[type=area_effect_cloud,tag=ice_cd1ri1] at @s rotated as @p[tag=!CoolDown1] run tp @s ~ ~ ~ ~ ~
...
execute as @e[type=area_effect_cloud,tag=ice_cd1ri1] at @s positioned ^ ^-1.33 ^0.5 run effect give @e[distance=..0.75] mining_fatigue 4 1 true
execute as @e[type=area_effect_cloud,tag=ice_cd1ri1] at @s positioned ^ ^-1.33 ^0.5 run effect give @e[distance=..0.75] weakness 4 0 true
