...
execute if entity @s[tag=!CoolDown1,tag=ArcticCore1,tag=!Permafrost1,tag=!Icefall1] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["ice_cd1","getRot"],Particle:"block air",Duration:14,Radius:1f}
