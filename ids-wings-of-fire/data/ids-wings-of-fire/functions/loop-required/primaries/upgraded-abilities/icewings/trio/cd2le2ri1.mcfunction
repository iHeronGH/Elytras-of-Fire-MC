...
execute if entity @s[tag=!CoolDown1,tag=!ArcticCore1,tag=Permafrost2,tag=Icefall1] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["ice_cd2le2ri1","getRot"],Particle:"block air",Duration:18,Radius:1f}
