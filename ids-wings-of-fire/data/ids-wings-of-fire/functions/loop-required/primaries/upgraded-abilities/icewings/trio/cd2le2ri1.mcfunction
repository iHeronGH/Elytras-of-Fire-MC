...
#Place Snow
execute as @e[type=area_effect_cloud,tag=ice_cd2le2ri1] at @s positioned ^-0.45 ^ ^0.7 unless block ~ ~-0.8 ~ #ids-wings-of-fire:families/airs if block ~ ~ ~ #ids-wings-of-fire:families/airs run setblock ~ ~ ~ snow replace
execute as @e[type=area_effect_cloud,tag=ice_cd2le2ri1] at @s positioned ^0.45 ^ ^0.7 unless block ~ ~-0.8 ~ #ids-wings-of-fire:families/airs if block ~ ~ ~ #ids-wings-of-fire:families/airs run setblock ~ ~ ~ snow replace
