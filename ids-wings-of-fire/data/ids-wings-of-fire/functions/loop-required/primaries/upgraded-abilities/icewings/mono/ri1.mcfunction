...
execute if entity @s[tag=!CoolDown1,tag=!ArcticCore1,tag=!Permafrost1,tag=Icefall1] at @s run summon area_effect_cloud ~ ~1.2 ~ {Tags:["ice_ri1","getRot"],Particle:"block air",Duration:18,Radius:1f}
...
execute as @e[type=area_effect_cloud,tag=ice_ri1] at @s positioned ^ ^-1.33 ^0.5 run tag @e[distance=..0.75] add hasFrost1
