...
execute if entity @s[tag=Oxygenate1,tag=!Wildfire1,tag=!Wildfire2,tag=Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/duo/cd1ri1
execute if entity @s[tag=Oxygenate2,tag=!Wildfire1,tag=!Wildfire2,tag=Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/duo/cd2ri1
execute if entity @s[tag=Oxygenate3,tag=!Wildfire1,tag=!Wildfire2,tag=Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/duo/cd3ri1
execute if entity @s[tag=!Oxygenate1,tag=!Oxygenate2,tag=!Oxygenate3,tag=Wildfire1,tag=Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/duo/lf1ri1
execute if entity @s[tag=!Oxygenate1,tag=!Oxygenate2,tag=!Oxygenate3,tag=Wildfire2,tag=Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/duo/lf2ri1

	#Mono
execute if entity @s[tag=Oxygenate1,tag=!Wildfire1,tag=!Wildfire2,tag=!Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/mono/cd1
execute if entity @s[tag=Oxygenate2,tag=!Wildfire1,tag=!Wildfire2,tag=!Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/mono/cd2
execute if entity @s[tag=Oxygenate3,tag=!Wildfire1,tag=!Wildfire2,tag=!Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/mono/cd3
execute if entity @s[tag=!Oxygenate1,tag=!Oxygenate2,tag=!Oxygenate3,tag=Wildfire1,tag=!Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/mono/lf1
execute if entity @s[tag=!Oxygenate1,tag=!Oxygenate2,tag=!Oxygenate3,tag=Wildfire2,tag=!Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/mono/lf2
execute if entity @s[tag=!Oxygenate1,tag=!Oxygenate2,tag=!Oxygenate3,tag=!Wildfire1,tag=!Wildfire2,tag=Blaze1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/skywings/mono/ri1
