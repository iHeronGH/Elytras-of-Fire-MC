...
execute if entity @s[tag=HighTide1,tag=!Waterlogged1,tag=!Waterlogged2,tag=Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/duo/cd1ri1
execute if entity @s[tag=HighTide2,tag=!Waterlogged1,tag=!Waterlogged2,tag=Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/duo/cd2ri1
execute if entity @s[tag=HighTide3,tag=!Waterlogged1,tag=!Waterlogged2,tag=Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/duo/cd3ri1
execute if entity @s[tag=!HighTide1,tag=!HighTide2,tag=!HighTide3,tag=Waterlogged1,tag=Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/duo/le1ri1
execute if entity @s[tag=!HighTide1,tag=!HighTide2,tag=!HighTide3,tag=Waterlogged2,tag=Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/duo/le2ri1

	#Mono
execute if entity @s[tag=HighTide1,tag=!Waterlogged1,tag=!Waterlogged2,tag=!Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/mono/cd1
execute if entity @s[tag=HighTide2,tag=!Waterlogged1,tag=!Waterlogged2,tag=!Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/mono/cd2
execute if entity @s[tag=HighTide3,tag=!Waterlogged1,tag=!Waterlogged2,tag=!Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/mono/cd3
execute if entity @s[tag=!HighTide1,tag=!HighTide2,tag=!HighTide3,tag=Waterlogged1,tag=!Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/mono/le1
execute if entity @s[tag=!HighTide1,tag=!HighTide2,tag=!HighTide3,tag=Waterlogged2,tag=!Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/mono/le2
execute if entity @s[tag=!HighTide1,tag=!HighTide2,tag=!HighTide3,tag=!Waterlogged1,tag=!Waterlogged2,tag=Torrent1] run function ids-wings-of-fire:loop-required/primaries/upgraded-abilities/seawings/mono/ri1
