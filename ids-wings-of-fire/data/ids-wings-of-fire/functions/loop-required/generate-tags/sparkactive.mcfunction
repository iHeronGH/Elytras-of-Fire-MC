...
#Ready Spark Punch
execute if entity @s[tag=!Activator,nbt={SelectedItem:{tag:{emberstrike:1}}}] run replaceitem entity @s weapon.offhand carrot_on_a_stick{CustomModelData:1,sparkactivate:1,activator:1}
