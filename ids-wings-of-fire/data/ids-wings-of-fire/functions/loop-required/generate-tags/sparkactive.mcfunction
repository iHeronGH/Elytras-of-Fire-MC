...
#Ready Spark Punch
execute if entity @s[nbt={SelectedItem:{tag:{emberstrike:1}}},nbt=!{Inventory:[{Slot:-106b}]}] run replaceitem entity @s weapon.offhand carrot_on_a_stick{CustomModelData:1,sparkactivate:1,activator:1}
