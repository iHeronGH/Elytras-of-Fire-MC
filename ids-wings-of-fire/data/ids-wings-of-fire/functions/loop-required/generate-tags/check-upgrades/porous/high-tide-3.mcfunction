...
#Add CheckTags
execute if entity @s[scores={HighTide3=1..},tag=HighTide1] run tag @s add HighTide3_T1AO
execute if entity @s[scores={HighTide3=1..},tag=HighTide2] run tag @s add HighTide3_T2AO
execute if entity @s[scores={HighTide3=1..},tag=HighTide3] run tag @s add HighTide3_T3AO
execute if score @s[scores={HighTide3=1..},tag=HighTide3_T2AO,tag=!HighTide3_T3AO] xp < t1 xp run tag @s add HighTide3_NEXp
execute if entity @s[scores={HighTide3=1..},tag=!HighTide1,tag=HighTide2,tag=!HighTide3,tag=!HighTide3_T1AO,tag=HighTide3_T2AO,tag=!HighTide3_T3AO,tag=!HighTide3_NEXp] if score @s xp >= t1 xp run tag @s add HighTide3_temp
...
execute if entity @s[scores={HighTide3=1..},tag=!HighTide3_T2AO,tag=!HighTide3_T3AO] run tellraw @s ["",{"text":"You must buy the previous upgrade in order to purchase this!","color":"gray"}]
