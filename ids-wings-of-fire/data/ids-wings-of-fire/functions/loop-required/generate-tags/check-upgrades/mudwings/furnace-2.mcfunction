...
#Add CheckTags
execute if entity @s[tag=Furnace1] run tag @s add Furnace2_T1AO
execute if entity @s[tag=Furnace2] run tag @s add Furnace2_T2AO
execute if entity @s[tag=Furnace3] run tag @s add Furnace2_T3AO
execute if score @s[tag=Furnace2_T1AO,tag=!Furnace2_T2AO,tag=!Furnace2_T3AO] xp < t1 xp run tag @s add Furnace2_NEXp
execute if entity @s[tag=Furnace2_T1AO,tag=!Furnace2_T2AO,tag=!Furnace2_T3AO,tag=!Furnace2_NEXp] run tag @s add Furnace2_temp
...
execute if entity @s[tag=!Furnace2_T1AO,tag=!Furnace2_T2AO,tag=!Furnace2_T3AO] run tellraw @s [{"text":"You must buy the previous upgrade in order to purchase this!","color":"gray"}]
