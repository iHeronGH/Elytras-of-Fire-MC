...
#Add CheckTags
execute if entity @s[tag=ArcticCore1] run tag @s add ArcticCore1_T1AO
execute if entity @s[tag=ArcticCore2] run tag @s add ArcticCore1_T2AO
execute if entity @s[tag=ArcticCore3] run tag @s add ArcticCore1_T3AO
...
execute if entity @s[tag=!ArcticCore1_T1AO,tag=!ArcticCore1_T2AO,tag=!ArcticCore1_T3AO,tag=!ArcticCore1_NEXp] run tag @s add ArcticCore1_temp
