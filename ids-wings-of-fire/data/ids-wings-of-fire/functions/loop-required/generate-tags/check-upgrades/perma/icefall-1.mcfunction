...
#Add CheckTags
execute if entity @s[scores={Icefall1=1..},tag=Icefall1] run tag @s add Icefall_T1AO
execute if score @s[scores={Icefall1=1..},tag=!Icefall_T1AO] xp < t3 xp run tag @s add Icefall_NEXp
execute if entity @s[scores={Icefall1=1..},tag=!Icefall1,tag=!Icefall_T1AO,tag=!Icefall_NEXp] if score @s xp >= t3 xp run tag @s add Icefall_temp
