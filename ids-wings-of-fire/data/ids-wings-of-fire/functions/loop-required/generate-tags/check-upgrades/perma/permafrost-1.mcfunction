...
#Add CheckTags
execute if entity @s[tag=Permafrost1] run tag @s add Permafrost1_T1AO
execute if entity @s[tag=Permafrost2] run tag @s add Permafrost1_T2AO
execute if score @s[tag=!Permafrost1_T1AO,tag=!Permafrost1_T2AO] xp < t2 xp run tag @s add Permafrost1_NEXp
execute if entity @s[tag=!Permafrost1_T1AO,tag=!Permafrost1_T2AO,tag=!Permafrost1_NEXp] run tag @s add Permafrost1_temp
...
execute if entity @s[tag=Permafrost1_temp] run tellraw @s [{"text":"You have successfully purchased ","color":"gray"},{"text":"Permafrost I","color":"aqua","bold":true},{"text":"!","color":"gray"}]
execute if entity @s[tag=Permafrost1_temp] run tag @s add Permafrost1
execute if entity @s[tag=Permafrost1_temp,tag=Permafrost1] run xp add @s -450
