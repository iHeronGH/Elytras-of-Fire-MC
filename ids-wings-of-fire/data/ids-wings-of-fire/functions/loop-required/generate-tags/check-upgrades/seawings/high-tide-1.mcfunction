...
#Add CheckTags
execute if entity @s[tag=HighTide1] run tag @s add HighTide1_T1AO
execute if entity @s[tag=HighTide2] run tag @s add HighTide1_T2AO
execute if entity @s[tag=HighTide3] run tag @s add HighTide1_T3AO
execute if score @s[tag=!HighTide1_T1AO,tag=!HighTide1_T2AO,tag=!HighTide1_T3AO] xp < t1 xp run tag @s add HighTide1_NEXp
execute if entity @s[tag=!HighTide1_T1AO,tag=!HighTide1_T2AO,tag=!HighTide1_T3AO,tag=!HighTide1_NEXp] run tag @s add HighTide1_temp
