...
#Add CheckTags
execute if entity @s[tag=ArcticCore1] run tag @s add ArcticCore2_T1AO
execute if entity @s[tag=ArcticCore2] run tag @s add ArcticCore2_T2AO
execute if entity @s[tag=ArcticCore3] run tag @s add ArcticCore2_T3AO
execute if score @s[tag=ArcticCore2_T1AO,tag=!ArcticCore2_T2AO,tag=!ArcticCore2_T3AO] xp < t1 xp run tag @s add ArcticCore2_NEXp
execute if entity @s[tag=ArcticCore2_T1AO,tag=!ArcticCore2_T2AO,tag=!ArcticCore2_T3AO,tag=!ArcticCore2_NEXp] run tag @s add ArcticCore2_temp
...
execute if entity @s[tag=!ArcticCore2_T1AO,tag=!ArcticCore2_T2AO,tag=!ArcticCore2_T3AO] run tellraw @s [{"text":"You must buy the previous upgrade in order to purchase this!","color":"gray"}]
