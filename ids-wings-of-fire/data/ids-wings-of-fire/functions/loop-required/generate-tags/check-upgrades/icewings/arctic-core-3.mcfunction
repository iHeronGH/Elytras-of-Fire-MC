...
#Add CheckTags
execute if entity @s[tag=ArcticCore1] run tag @s add ArcticCore3_T1AO
execute if entity @s[tag=ArcticCore2] run tag @s add ArcticCore3_T2AO
execute if entity @s[tag=ArcticCore3] run tag @s add ArcticCore3_T3AO
execute if score @s[tag=ArcticCore3_T2AO,tag=!ArcticCore3_T3AO] xp < t1 xp run tag @s add ArcticCore3_NEXp
execute if entity @s[tag=!ArcticCore3_T1AO,tag=ArcticCore3_T2AO,tag=!ArcticCore3_T3AO,tag=!ArcticCore3_NEXp] run tag @s add ArcticCore3_temp
...
execute if entity @s[tag=!ArcticCore3_T2AO,tag=!ArcticCore3_T3AO] run tellraw @s [{"text":"You must buy the previous upgrade in order to purchase this!","color":"gray"}]
