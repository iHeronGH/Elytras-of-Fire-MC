...
#Add CheckTags
execute if entity @s[tag=NaturesWrath1] run tag @s add NaturesWrath1_T1AO
execute if entity @s[tag=NaturesWrath2] run tag @s add NaturesWrath1_T2AO
execute if score @s[tag=!NaturesWrath1_T1AO,tag=!NaturesWrath1_T2AO] xp < t2 xp run tag @s add NaturesWrath1_NEXp
execute if entity @s[tag=!NaturesWrath1_T1AO,tag=!NaturesWrath1_T2AO,tag=!NaturesWrath1_NEXp] run tag @s add NaturesWrath1_temp
...
execute if entity @s[tag=NaturesWrath1_temp] run tellraw @s [{"text":"You have successfully purchased ","color":"gray"},{"text":"Nature's Wrath I","color":"dark_green","bold":true},{"text":"!","color":"gray"}]
execute if entity @s[tag=NaturesWrath1_temp] run tag @s add NaturesWrath1
execute if entity @s[tag=NaturesWrath1_temp,tag=NaturesWrath1] run xp add @s -450
