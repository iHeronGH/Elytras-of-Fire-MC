...
#Add CheckTags
execute if entity @s[tag=Noxious1] run tag @s add Noxious1_T1AO
execute if entity @s[tag=Noxious2] run tag @s add Noxious1_T2AO
execute if score @s[tag=!Noxious1_T1AO,tag=!Noxious1_T2AO] xp < t2 xp run tag @s add Noxious1_NEXp
execute if entity @s[tag=!Noxious1_T1AO,tag=!Noxious1_T2AO,tag=!Noxious1_NEXp] run tag @s add Noxious1_temp
...
#Purchase Noxious 1
execute if entity @s[tag=Noxious1_temp] run tellraw @s [{"text":"You have successfully purchased ","color":"gray"},{"text":"Noxious I","color":"white","bold":true},{"text":"!","color":"gray"}]
execute if entity @s[tag=Noxious1_temp] run tag @s add Noxious1
execute if entity @s[tag=Noxious1_temp,tag=Noxious1] run xp add @s -450
