...
#Add CheckTags
execute if entity @s[scores={Superheat2=1..},tag=Superheat1] run tag @s add Superheat2_T1AO
execute if entity @s[scores={Superheat2=1..},tag=Superheat2] run tag @s add Superheat2_T2AO
execute if entity @s[scores={Superheat2=1..},tag=Superheat3] run tag @s add Superheat2_T3AO
execute if score @s[scores={Superheat2=1..},tag=Superheat2_T1AO,tag=!Superheat2_T2AO,tag=!Superheat2_T3AO] xp < t1 xp run tag @s add Superheat2_NEXp
execute if entity @s[scores={Superheat2=1..},tag=Superheat1,tag=!Superheat2,tag=!Superheat3,tag=Superheat2_T1AO,tag=!Superheat2_T2AO,tag=!Superheat2_T3AO,tag=!Superheat2_NEXp] if score @s xp >= t1 xp run tag @s add Superheat2_temp
...
execute if entity @s[scores={Superheat2=1..},tag=!Superheat2_T1AO,tag=!Superheat2_T2AO,tag=!Superheat2_T3AO] run tellraw @s ["",{"text":"You must buy the previous upgrade in order to purchase this!","color":"gray"}]
