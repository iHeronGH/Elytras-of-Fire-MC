...
execute if entity @s[tag=!Tremors1_T1AO,tag=!Tremors1_T2AO,tag=!Tremors1_NEXp] xp run tag @s add Tremors1_temp
...
#Purchase Tremors 1
execute if entity @s[tag=Tremors1_temp] xp run tellraw @s [{"text":"You have successfully purchased ","color":"gray"},{"text":"Tremors I","color":"gold","bold":true},{"text":"!","color":"gray"}]
execute if entity @s[tag=Tremors1_temp] xp run tag @s add Tremors1
execute if entity @s[tag=Tremors1_temp,tag=Tremors1] xp run xp add @s -400
