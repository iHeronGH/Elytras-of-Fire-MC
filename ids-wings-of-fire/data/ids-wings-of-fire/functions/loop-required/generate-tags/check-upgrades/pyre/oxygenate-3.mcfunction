...
#Add CheckTags
execute if entity @s[scores={Oxygenate3=1..},tag=Oxygenate1] run tag @s add Oxygenate3_T1AO
execute if entity @s[scores={Oxygenate3=1..},tag=Oxygenate2] run tag @s add Oxygenate3_T2AO
execute if entity @s[scores={Oxygenate3=1..},tag=Oxygenate3] run tag @s add Oxygenate3_T3AO
execute if score @s[scores={Oxygenate3=1..},tag=Oxygenate3_T2AO,tag=!Oxygenate3_T3AO] xp < t1 xp run tag @s add Oxygenate3_NEXp
execute if entity @s[scores={Oxygenate3=1..},tag=!Oxygenate1,tag=Oxygenate2,tag=!Oxygenate3,tag=!Oxygenate3_T1AO,tag=Oxygenate3_T2AO,tag=!Oxygenate3_T3AO,tag=!Oxygenate3_NEXp] if score @s xp >= t1 xp run tag @s add Oxygenate3_temp
...
execute if entity @s[scores={Oxygenate3=1..},tag=!Oxygenate3_T2AO,tag=!Oxygenate3_T3AO] run tellraw @s ["",{"text":"You must buy the previous upgrade in order to purchase this!","color":"gray"}]
