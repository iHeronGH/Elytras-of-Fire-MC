...
#Add CheckTags
execute if entity @s[scores={Superheat1=1..},tag=Superheat1] run tag @s add Superheat1_T1AO
execute if entity @s[scores={Superheat1=1..},tag=Superheat2] run tag @s add Superheat1_T2AO
execute if entity @s[scores={Superheat1=1..},tag=Superheat3] run tag @s add Superheat1_T3AO
execute if score @s[scores={Superheat1=1..},tag=!Superheat1_T1AO,tag=!Superheat1_T2AO,tag=!Superheat1_T3AO] xp < t1 xp run tag @s add Superheat1_NEXp
execute if entity @s[scores={Superheat1=1..},tag=!Superheat1,tag=!Superheat2,tag=!Superheat3,tag=!Superheat1_T1AO,tag=!Superheat1_T2AO,tag=!Superheat1_T3AO,tag=!Superheat1_NEXp] if score @s xp >= t1 xp run tag @s add Superheat1_temp
