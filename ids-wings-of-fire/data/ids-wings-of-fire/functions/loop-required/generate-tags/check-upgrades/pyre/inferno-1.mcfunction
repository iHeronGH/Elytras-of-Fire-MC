...
#Add CheckTags
execute if entity @s[tag=Inferno1] run tag @s add Inferno_T1AO
execute if score @s[tag=!Inferno_T1AO] xp < t3 xp run tag @s add Inferno_NEXp
execute if entity @s[tag=!Inferno_T1AO,tag=!Inferno_NEXp] run tag @s add Inferno_temp
