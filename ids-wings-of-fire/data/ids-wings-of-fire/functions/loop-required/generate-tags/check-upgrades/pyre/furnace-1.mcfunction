...
#Add CheckTags
execute if entity @s[scores={Furnace1=1..},tag=Furnace1] run tag @s add Furnace1_T1AO
execute if entity @s[scores={Furnace1=1..},tag=Furnace2] run tag @s add Furnace1_T2AO
execute if entity @s[scores={Furnace1=1..},tag=Furnace3] run tag @s add Furnace1_T3AO
execute if score @s[scores={Furnace1=1..},tag=!Furnace1_T1AO,tag=!Furnace1_T2AO,tag=!Furnace1_T3AO] xp < t1 xp run tag @s add Furnace1_NEXp
execute if entity @s[scores={Furnace1=1..},tag=!Furnace1,tag=!Furnace2,tag=!Furnace3,tag=!Furnace1_T1AO,tag=!Furnace1_T2AO,tag=!Furnace1_T3AO,tag=!Furnace1_NEXp] if score @s xp >= t1 xp run tag @s add Furnace1_temp
