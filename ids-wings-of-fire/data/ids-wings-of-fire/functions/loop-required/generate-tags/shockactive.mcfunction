...
#Ready Terrashock
execute if entity @s[tag=!Activator,nbt={SelectedItem:{tag:{crumble:1}}}] run replaceitem entity @s weapon.offhand carrot_on_a_stick{CustomModelData:1,shockactivate:1,activator:1}
