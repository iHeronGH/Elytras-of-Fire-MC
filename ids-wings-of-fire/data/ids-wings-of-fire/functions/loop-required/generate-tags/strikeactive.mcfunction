...
execute if entity @s[nbt={SelectedItem:{tag:{sharpedge:1}}},nbt=!{Inventory:[{Slot:-106b}]}] run replaceitem entity @s weapon.offhand carrot_on_a_stick{strikeactivate:1,activator:1}
