...
#Ready Sky Surge
execute if entity @s[scores={Activator=0},nbt={SelectedItem:{tag:{adrenaline:1}}}] run replaceitem entity @s weapon.offhand carrot_on_a_stick{surgeactivate:1,activator:1}
