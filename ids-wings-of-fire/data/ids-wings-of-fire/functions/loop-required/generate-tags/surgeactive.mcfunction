...
#Ready Sky Surge
execute if entity @s[tag=!Activator,nbt={SelectedItem:{tag:{adrenaline:1}}}] run replaceitem entity @s weapon.offhand carrot_on_a_stick{CustomModelData:1,surgeactivate:1,activator:1}
