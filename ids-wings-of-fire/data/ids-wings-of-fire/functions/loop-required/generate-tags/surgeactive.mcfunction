...
#Ready Sky Surge
execute if entity @s[nbt={SelectedItem:{tag:{adrenaline:1}}},nbt=!{Inventory:[{Slot:-106b}]}] run replaceitem entity @s weapon.offhand carrot_on_a_stick{surgeactivate:1,activator:1}
